...
//        object2.printValues();
//    }
       public static void main(String[] args) {TripleGeneric<Base1,Base2,Base3> triple = new TripleGeneric<>();
          triple.setValues(new Base1(),new Base2(),new Base3());
          triple.useAllBaseMethods();
